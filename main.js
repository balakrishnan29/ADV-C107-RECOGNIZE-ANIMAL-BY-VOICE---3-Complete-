...
function startClassifictaion() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/-_nM7ufPz/model.json',modelReady);
}
function modelReady() {
...
function gotResult(error, results) {
    if(error){
        ...
        if(results[0].label == "Barking"){
            ...
            img.src = "https://i.pinimg.com/originals/eb/ed/e5/ebede532f6f5cf644a3fcf79d14b046c.gif";
            lion = lion+1;
            document.getElementById("detected").innerHTML = "Detected Horse - "+ lion;
        }
        else if(results[0].label == "Braying"){
            img.src = "https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/6a684b71805451.5ca68f8439065.gif";
            cow = cow+1;
            document.getElementById("detected").innerHTML = "Detected Donkey - "+ cow;
        }
        else{
